...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label_5.setStyleSheet(" doctors-with-big-speech-bubble-on-blue-background-medical-internet-consultation-doctor-on-presentati.jpeg")
...
"background-color: rgb(255, 170, 0);")
        ...
        self.pushButton.setGeometry(QtCore.QRect(820, 490, 281, 41))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Connexion Sécretaire"))
        ...
        self.nom.setPlaceholderText(_translate("Form", "Nom d\'utilisateur"))
